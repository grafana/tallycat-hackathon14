...
export const SidebarMenuFlyout = ({ trigger, children, icon, label }: SidebarMenuFlyoutProps) => {
        ...
        >
          {(icon || label) && (
            <div className="flex items-center gap-2 mb-2 pb-2 border-b border-border">
              {icon && <span className="w-5 h-5 text-xl text-muted-foreground flex items-center">{icon}</span>}
